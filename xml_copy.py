...
class xmlProcess(self,file_xml):
    """Intialize the class"""
    def __init__(self,country):
        self.file_xml =file_xml
        
        
    def convDf(self,file_xml):
                    ...
                    if child.tag == '{http://www.SDMX.org/resources/SDMXML/schemas/v2_0/generic}Obs':
                        for subchild in child:
                            ...
                            if subchild.tag == '{http://www.SDMX.org/resources/SDMXML/schemas/v2_0/generic}ObsValue':
                                ...
                                xmlDict[country][flow][product][year]['obs'] =  0.0
        ...
        Dict2List = self.grab_children(xmlDict)
        df = pd.DataFrame(Dict2List, columns= cols)  
        return xml_Df                         
        pdb.set_trace()                       
